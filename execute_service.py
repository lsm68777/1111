...
print("[Phoenix95] Execute Service - 인코딩 설정 완료")

# 로깅 설정 (기존 코드에 force=True만 추가)
logging.basicConfig(
    level=logging.INFO,
...
class Phoenix95ExecuteConfig:
    ...
    MAX_POSITION_SIZE = 0.01               # 최대 포지션 크기 1%
    ...
    # 💰 Kelly Criterion 설정
    KELLY_MAX_FRACTION = 0.02              # Kelly 최대 비율 2%
